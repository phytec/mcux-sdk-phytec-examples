...
- pin_list:
  ...
  - {pin_num: U8, peripheral: LPI2C5, signal: SDA, pin_signal: GPIO_LPSR_08, identifier: I2C5_SDA, software_input_on: Enable, pull_up_down_config: Pull_Up}
  - {pin_num: P5, peripheral: LPI2C5, signal: SCL, pin_signal: GPIO_LPSR_09, identifier: I2C5_SCL, software_input_on: Enable, pull_up_down_config: Pull_Up}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
