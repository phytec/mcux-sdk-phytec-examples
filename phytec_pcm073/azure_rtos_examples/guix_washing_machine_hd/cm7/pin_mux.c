...
pin_labels:
- {pin_num: P5, pin_signal: GPIO_LPSR_09, label: 'DMIC_DATA0/U41[5]/J50[20]/LPSPI6_CS0/J26[11]', identifier: DMIC_DATA0;I2C5_SCL}
- {pin_num: U8, pin_signal: GPIO_LPSR_08, label: 'DMIC_CLK/U41[1]/U44[1]/J50[18]', identifier: DMIC_CLK;I2C5_SDA}
...
- pin_list:
  ...
  - {pin_num: P5, peripheral: LPI2C5, signal: SCL, pin_signal: GPIO_LPSR_09, identifier: I2C5_SCL, software_input_on: Enable, open_drain: Enable, drive_strength: Normal}
  - {pin_num: U8, peripheral: LPI2C5, signal: SDA, pin_signal: GPIO_LPSR_08, identifier: I2C5_SDA, software_input_on: Enable, open_drain: Enable, drive_strength: Normal}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitMipiPanelPins(void) {
  ...
  IOMUXC_SetPinMux(
      ...
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_LPSR_08_LPI2C5_SDA,         /* GPIO_LPSR_08 is configured as LPI2C5_SDA */
      1U);                                    /* Software Input On Field: Force input path of pad GPIO_LPSR_08 */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_LPSR_09_LPI2C5_SCL,         /* GPIO_LPSR_09 is configured as LPI2C5_SCL */
      1U);                                    /* Software Input On Field: Force input path of pad GPIO_LPSR_09 */
  IOMUXC_SetPinConfig(
  ...
  IOMUXC_SetPinConfig(
      ...
      0x00U);                                 /* Slew Rate Field: Slow Slew Rate
                                                 ...
                                                 Domain write protection lock: Neither of DWP bits is locked */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_LPSR_08_LPI2C5_SDA,         /* GPIO_LPSR_08 PAD functional properties : */
      0x20U);                                 /* Slew Rate Field: Slow Slew Rate
                                                 ...
                                                 Domain write protection lock: Neither of DWP bits is locked */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_LPSR_09_LPI2C5_SCL,         /* GPIO_LPSR_09 PAD functional properties : */
      0x20U);                                 /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: normal driver
                                                 Pull / Keep Select Field: Pull Disable
                                                 Pull Up / Down Config. Field: Weak pull down
