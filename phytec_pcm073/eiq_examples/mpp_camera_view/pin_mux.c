...
pin_labels:
- {pin_num: E8, pin_signal: GPIO_DISP_B2_00, label: 'BT_CFG[6]', identifier: CAMERA_PWDN}
...
- {pin_num: R10, pin_signal: GPIO_SNVS_00, label: 'J42[3]', identifier: CAMERA_RST}
...
- options: {callFromInitBoot: 'false', coreID: cm7, enableClock: 'true'}
- pin_list:
  - {pin_num: E8, peripheral: GPIO11, signal: 'gpio_io, 01', pin_signal: GPIO_DISP_B2_00, direction: OUTPUT, pull_up_down_config: Pull_Up}
  - {pin_num: R10, peripheral: GPIO13, signal: 'gpio_io, 03', pin_signal: GPIO_SNVS_00, direction: OUTPUT, pull_up_down_config: Pull_Up}
...
void BOARD_InitMipiCameraPins(void) {
  ...
  /* GPIO configuration of CAMERA_PWDN on GPIO_DISP_B2_00 (pin E8) */
  ...
  GPIO_PinInit(GPIO11, 1U, &CAMERA_PWDN_config);

  /* GPIO configuration of CAMERA_RST on GPIO_SNVS_00_DIG (pin R10) */
  ...
  GPIO_PinInit(GPIO13, 3U, &CAMERA_RST_config);
  ...
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_DISP_B2_00_GPIO11_IO01,     /* GPIO_DISP_B2_00 is configured as GPIO11_IO01 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
  ...
  IOMUXC_SetPinConfig(
      ...
      0x0AU);                                 /* Slew Rate Field: Slow Slew Rate
                                                 ...
                                                 Domain write protection lock: Neither of DWP bits is locked */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_DISP_B2_00_GPIO11_IO01,     /* GPIO_DISP_B2_00 PAD functional properties : */
      0x0AU);                                 /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: high drive strength
                                                 Pull / Keep Select Field: Pull Disable, Highz
                                                 Pull Up / Down Config. Field: Weak pull up
