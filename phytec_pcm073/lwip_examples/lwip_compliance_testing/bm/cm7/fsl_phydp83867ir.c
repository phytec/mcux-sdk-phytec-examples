...
status_t PHY_DP83867IR_Write(phy_handle_t *handle, uint16_t phyReg, uint16_t data)
{
	if(phyReg > 0x1f)
	{
		PHY_DP83867IR_WRITE(handle, 0xd, 0x1f);
		PHY_DP83867IR_WRITE(handle, 0xe, phyReg);
		PHY_DP83867IR_WRITE(handle, 0xd, 0x401f);
		PHY_DP83867IR_WRITE(handle, 0xe, data);
	}
	else
...
status_t PHY_DP83867IR_Read(phy_handle_t *handle, uint16_t phyReg, uint16_t *pData)
{
	if(phyReg > 0x1f)
	{
		...
		PHY_DP83867IR_WRITE(handle, 0xe, phyReg);
		PHY_DP83867IR_WRITE(handle, 0xd, 0x401f);
		PHY_DP83867IR_READ(handle, 0xe, pData);
	}
	else
