...
{
    /* * The following steps just show how to configure the PLL clock sources using the clock driver
     * on M7 core side . Please note that the ROM has already configured the SYSTEM PLL1 to 800Mhz
     * when power up the SOC, meanwhile A core would enable SYSTEM PLL1, SYSTEM PLL2 and SYSTEM PLL3
     * by U-Boot. Therefore, there is no need to configure the system PLL again on M7 side,
     * otherwise it would have a risk to make the SOC hang.
     */
